...
set_property PACKAGE_PIN K1 [get_ports {ST[3]}]
set_property PACKAGE_PIN J1 [get_ports {ST[2]}]
set_property PACKAGE_PIN H2 [get_ports {ST[1]}]
set_property PACKAGE_PIN G2 [get_ports {ST[0]}]
...
set_property PACKAGE_PIN V3 [get_ports {SW[0]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports {ST[3]}]
...
set_property PULLTYPE PULLDOWN [get_ports {SW[3]}]
